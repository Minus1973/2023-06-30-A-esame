...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        row1 = ft.Row([self._ddSquadra,self._btnCreaGrafo], alignment=ft.MainAxisAlignment.CENTER)
        ...
        row2 = ft.Row([self._ddAnno, self._btnDettagli], alignment=ft.MainAxisAlignment.CENTER,
